...
func NewLogger(out io.Writer, setters ...Setter) *Logger {
	switch l := out.(type) {
	case zerolog.Logger:
...
// FromLogger returns a new Logger instance using existing zerolog log.
func FromLogger(log zerolog.Logger, setters ...Setter) *Logger {
